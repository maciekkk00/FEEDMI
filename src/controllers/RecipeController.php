...
class RecipeController extends AppController {
    ...
    private $messages = []; //do tej zmiennej bedziemy dodawali nasze zmienne
    ...
    public function addRecipe()
    {
        if($this->isPost() && is_uploaded_file($_FILES['file']['tmp_name']) && $this->validate($_FILES['file'])) { //sprawdzamy czy zostala wykonana metoda POST
            ...
            return $this->render('recipes', [                   //jesli wszystko sie uda to chcemy zwrocic strone z przepisami
                'recipes' => $this->recipeRepository->getRecipes(),

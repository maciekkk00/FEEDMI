...
class RecipeController extends AppController { //cala logika naszego uploadu
    ...
    public function addRecipe()
    {
        if($this->isPost() && is_uploaded_file($_FILES['file']['tmp_name']) && $this->validate($_FILES['file'])) {
            ...
            $recipe = new Recipe($_POST['title'], $_POST['description'], $_POST['skladnik1'], $_POST['skladnik2'], $_POST['skladnik3'],
                $_POST['skladnik4'], $_POST['skladnik5'], $_POST['skladnik6'], $_POST['skladnik7'], $_POST['skladnik8'], $_POST['skladnik9'],
                $_POST['skladnik10'], $_FILES['file']['name']);
